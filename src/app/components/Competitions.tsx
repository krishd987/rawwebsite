...
const competitionsData = [
  ...
  {
    id: 2,
    name: 'DD Robocon 2026 - 82 Marks',
    organizer: 'Doordarshan & Ministry of Education',
    year: 2026,
    achievement: '82 Marks',
    description: 'DD Robocon 2026 entry with a strong score of 82 marks. Showcased solid robotics performance across design, control, and execution in the 2026 competition cycle.',
    tags: ['Mechanical Design', 'Autonomous Control', 'Electronics', 'High Score'],
  ...
  },
  {
    ...
    description: 'DD Robocon 2026 Stage 2 performance entry with 65 marks. Demonstrated consistent progress in robotics design, control systems, and on-stage execution.',
